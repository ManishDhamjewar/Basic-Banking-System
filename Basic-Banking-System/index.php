...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #00838f cyan z-depth-5">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            ...
            <button onclick="location.href='./php/transfermoney.php'" style="color:black" class="waves-effect waves-light #ffab00 amber accent-4 btn-large"><b>TRANSFER MONEY</b><i class="material-icons right">add_circle</i></button>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>2021 © Made by Manish Dhamjewar</b></h6>
